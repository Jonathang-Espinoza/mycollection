...
<section class="wrap" id="navbar-bread">
...
<section class="wrap" id="tutorial-video">
	<div class="container">
		...
		<div class="video-promo">
			...
			</div><!-- end col-sm-8 col-md-4 col-md-offset-2 -->
					...
					<div class="panel-body">
						...
						<div class="media">
							<div class="media-left">
								<img  class="media-object img-circle" src="<?php echo IMG_DIR.'user.png' ?>" width="64" height="64" alt="Foto del Perfil">
							</div><!-- end media-left -->
